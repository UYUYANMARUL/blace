...
use crate::precompiles::CustomPrecompileProvider;
use revm::{
...
impl<CTX, INSP> BlaceEvm<CTX, INSP>
where
...
impl<CTX, INSP> EvmTr for BlaceEvm<CTX, INSP>
where
    CTX: ContextTr<Cfg: revm::context::Cfg<Spec = SpecId>>,
{
    type Context = CTX;
...
impl<CTX, INSP> InspectorEvmTr for BlaceEvm<CTX, INSP>
where
